...
namespace CocktailApp.Migrations
{
    ...
    [Migration("20230816150055_RenameListToCocktailList")]
    partial class RenameListToCocktailList
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CocktailApp.Models.CocktailList", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CocktailApp.Models.CocktailListFavourite", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("CocktailListId")
                        .HasColumnType("uuid");

                    b.Property<DateTime>("DateAdded")
                        .HasColumnType("timestamp with time zone");

                    b.HasKey("UserId", "CocktailListId");

                    b.HasIndex("CocktailListId");

                    b.ToTable("ListFavourites");
                });

            modelBuilder.Entity("CocktailApp.Models.CocktailListItem", b =>
                {
                    b.Property<Guid>("CocktailListId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("CocktailListId", "CocktailId");

                    b.HasIndex("CocktailId");

                    b.ToTable("CocktailListItems");
                });
            ...
            modelBuilder.Entity("CocktailApp.Models.CocktailListFavourite", b =>
                {
                    b.HasOne("CocktailApp.Models.CocktailList", "CocktailList")
                        .WithMany()
                        .HasForeignKey("CocktailListId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
